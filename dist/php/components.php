  ...
  echo '
	...
	<div class="xs:px-4 flex h-16 items-center justify-between gap-8 px-2 sm:px-6 lg:px-8">
		...
		<div class="flex items-center gap-4 sm:flex">
			<a class="block rounded-md bg-orange-400 px-5 py-2 text-sm font-medium text-white transition hover:bg-orange-500" href="/"> Login </a>
			<a class="hidden rounded-md bg-zinc-200 px-5 py-2 text-sm font-medium text-orange-400 transition hover:text-orange-400/75 md:block" href="/"> Register </a>
